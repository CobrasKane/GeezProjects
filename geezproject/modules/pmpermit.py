...
#
""" geezproject module for keeping control who PM you. """
...
from geezproject import CMD_HELP, COUNT_PM, LASTMSG, LOGS, PM_AUTO_BAN, PM_LIMIT, bot
...
async def permitpm(event):
    ...
    if (
        ...
        try:
            from geezproject.modules.sql_helper.globals import gvarstatus
            from geezproject.modules.sql_helper.pm_permit_sql import is_approved
...
async def auto_accept(event):
    ...
    if (
        ...
        try:
            from geezproject.modules.sql_helper.globals import gvarstatus
            from geezproject.modules.sql_helper.pm_permit_sql import approve, is_approved
        except AttributeError:
            return
...
async def notifoff(noff_event):
    ...
    try:
        from geezproject.modules.sql_helper.globals import addgvar
    except AttributeError:
...
async def notifon(non_event):
    ...
    try:
        from geezproject.modules.sql_helper.globals import delgvar
    except AttributeError:
...
async def approvepm(apprvpm):
    ...
    try:
        from geezproject.modules.sql_helper.globals import gvarstatus
        from geezproject.modules.sql_helper.pm_permit_sql import approve
    except AttributeError:
...
async def disapprovepm(disapprvpm):
    try:
        from geezproject.modules.sql_helper.pm_permit_sql import dissprove
    except BaseException:
...
async def add_pmsg(cust_msg):
    ...
    try:
        import geezproject.modules.sql_helper.globals as sql
    except AttributeError:
